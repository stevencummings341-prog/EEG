...
## 2026-06-10 — Architecture Reorganization (No Experiment Run)

No experiment was run. The project was reorganized into a P10-style multi-dataset framework with `code/run.py` as the new manual entry, split dataset/model/experiment configs, phase folders, updated rules, and a filesystem operation log. Existing WBCIC-SHU results remain in their original `outputs/` locations.
